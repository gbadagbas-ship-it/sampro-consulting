...
(function () {
  ...
  function setTheme(theme) {
    ...
    if (mobileThemeToggle) {
      mobileThemeToggle.textContent = theme === "dark" ? "☀" : "☽";
    }
  }
  ...
  const translations = {
    fr: {
      ...
      contact: "Contact",
      heroDesc:
        "SAMPRO Consulting est un cabinet de formation, de conseil et de solutions digitales, spécialisé dans la formation linguistique, le développement des compétences, la communication, le digital et l'accompagnement stratégique des particuliers, entreprises et institutions.",
      ctaServices: "Découvrir nos services",
      ctaContact: "Nous contacter",
      slogan:
        "Parler avec assurance, inspirer avec passion, impacter avec conviction",
      aboutTag: "Qui sommes-nous ?",
      aboutSub:
        "Découvrez l'essence de SAMPRO Consulting à travers notre mission, nos valeurs et notre engagement.",
      aboutP1:
        "SAMPRO Consulting est une structure basée à Lomé, engagée dans le développement des compétences linguistiques, communicationnelles, professionnelles et digitales, avec une approche humaine, pratique et orientée résultats.",
      aboutP2:
        "Nous croyons que la maîtrise de la communication, des langues et des outils modernes est aujourd'hui un levier essentiel de réussite personnelle et professionnelle.",
      missionTitle: "Notre mission",
      missionText:
        "Accompagner les individus et les organisations à mieux communiquer, mieux se former et mieux se structurer, grâce à des solutions adaptées, accessibles et durables.",
      visionTitle: "Notre vision",
      visionText:
        "Devenir une référence en formation linguistique, informatique, développement des compétences et transformation digitale au Togo et en Afrique.",
      val1: "Excellence & Professionnalisme",
      val1desc:
        "Nous visons l'excellence dans chaque projet avec rigueur et dévouement.",
      val2: "Pédagogie & Impact",
      val2desc:
        "Des méthodes modernes pour des résultats concrets et durables.",
      val3: "Innovation & Adaptation",
      val3desc:
        "Toujours à la pointe des nouvelles technologies et des méthodes.",
      val4: "Proximité & Écoute",
      val4desc:
        "Un accompagnement personnalisé et humain au cœur de notre approche.",
      val5: "Discipline & Vision",
      val5desc: "Une approche structurée pour des résultats pérennes.",
      founderQuote:
        "Chaque projet est une opportunité d'impact, et chaque apprenant mérite les outils pour construire son avenir avec confiance.",
      founderName: "DEGBEDJI Koffi Samuel, Fondateur & CEO",
      galleryTag: "Notre univers",
      gallerySub:
        "Découvrez l'univers de SAMPRO Consulting à travers nos formations, séminaires et réalisations.",
      valuesTag: "Nos piliers",
      servicesTag: "Notre expertise",
      servicesSub:
        "Une gamme complète de services pour répondre à tous vos besoins en formation et développement.",
      dept1: "Formation Linguistique",
      dept1desc:
        "Anglais, français, chinois — cours généraux, professionnels et coaching personnalisé.",
      dept2: "Développement des Compétences",
      dept2desc:
        "Séminaires, leadership, prise de parole, orientation scolaire et coaching.",
      dept3: "Marketing Digital & Stratégie",
      dept3desc:
        "Stratégies de visibilité, création de contenu, gestion de pages professionnelles.",
      dept4: "Informatique & Solutions Digitales",
      dept4desc:
        "Création de sites web, maintenance, formation aux outils numériques.",
      dept5: "Communication Visuelle & Design",
      dept5desc:
        "Logos, affiches, flyers, bannières, identité visuelle et direction artistique.",
      dept6: "Impression & Production",
      dept6desc:
        "Supports de communication, tableaux photo, encadrements et impression.",
      ...
      directorSub:
        "Découvrez le parcours et la vision du fondateur qui guide notre excellence.",
      testTag: "Témoignages",
      testSub:
        "Des retours authentiques de personnes qui ont fait confiance à SAMPRO Consulting.",
      test1:
        "\"La formation en anglais business m'a permis de négocier des contrats internationaux avec confiance. L'approche personnalisée a fait toute la différence.\"",
      test1role: "Directeur, Logistique",
      test2:
        '"Le site web créé par SAMPRO Consulting a boosté nos ventes de 200% en seulement 3 mois. Une équipe professionnelle et à l\'écoute."',
      test2role: "Fondatrice, E-commerce",
      test3:
        '"Une expérience d\'apprentissage exceptionnelle. Les professeurs sont compétents et toujours disponibles. Je recommande vivement !"',
      ...
      ctaBonusDesc:
        "Réservez un appel de 30 minutes pour discuter de vos besoins spécifiques.",
      ctaBonusBtn: "Réserver maintenant",
      footerDesc:
        "Leader du conseil et de la formation à Lomé. Nous accompagnons les professionnels et les étudiants dans la maîtrise des langues et des outils digitaux.",
      navTitle: "Navigation",
    ...
    en: {
      ...
      contact: "Contact",
      heroDesc:
        "SAMPRO Consulting is a training, consulting and digital solutions firm, specializing in language training, skills development, communication, digital and strategic support for individuals, businesses and institutions.",
      ctaServices: "Discover our services",
      ctaContact: "Contact us",
      slogan:
        "Speak with confidence, inspire with passion, impact with conviction",
      aboutTag: "Who are we?",
      aboutSub:
        "Discover the essence of SAMPRO Consulting through our mission, values and commitment.",
      aboutP1:
        "SAMPRO Consulting is a structure based in Lomé, committed to the development of language, communication, professional and digital skills, with a human, practical and results-oriented approach.",
      aboutP2:
        "We believe that mastering communication, languages and modern tools is now an essential lever for personal and professional success.",
      missionTitle: "Our mission",
      missionText:
        "To support individuals and organizations to communicate better, train better and structure better, through adapted, accessible and sustainable solutions.",
      visionTitle: "Our vision",
      visionText:
        "To become a reference in language training, IT, skills development and digital transformation in Togo and Africa.",
      val1: "Excellence & Professionalism",
      val1desc:
        "We aim for excellence in every project with rigor and dedication.",
      ...
      founderQuote:
        "Every project is an opportunity for impact, and every learner deserves the tools to build their future with confidence.",
      founderName: "DEGBEDJI Koffi Samuel, Founder & CEO",
      galleryTag: "Our universe",
      gallerySub:
        "Discover the world of SAMPRO Consulting through our training, seminars and achievements.",
      valuesTag: "Our pillars",
      servicesTag: "Our expertise",
      servicesSub:
        "A complete range of services to meet all your training and development needs.",
      dept1: "Language Training",
      dept1desc:
        "English, French, Chinese — general, professional and coaching courses.",
      dept2: "Skills Development",
      dept2desc:
        "Seminars, leadership, public speaking, academic guidance and coaching.",
      dept3: "Digital Marketing & Strategy",
      dept3desc:
        "Visibility strategies, content creation, professional page management.",
      ...
      dept5desc:
        "Logos, posters, flyers, banners, visual identity and artistic direction.",
      ...
      directorTag: "Leadership",
      directorSub:
        "Discover the journey and vision of the founder who guides our excellence.",
      testTag: "Testimonials",
      testSub:
        "Authentic feedback from people who have trusted SAMPRO Consulting for their development.",
      test1:
        '"The business English training allowed me to negotiate international contracts with confidence. The personalized approach made all the difference."',
      test1role: "Director, Logistics",
      test2:
        '"The website created by SAMPRO Consulting boosted our sales by 200% in just 3 months. A professional and attentive team."',
      test2role: "Founder, E-commerce",
      test3:
        '"An exceptional learning experience. The teachers are competent and always available. I highly recommend!"',
      ...
      footerDesc:
        "Leader in consulting and training in Lomé. We support professionals and students in mastering languages and digital tools.",
      navTitle: "Navigation",
  ...
  (function () {
    ...
    console.log(
      "🔄 Carrousel témoignages activé — changement toutes les 3 secondes",
    );
  })();
  ...
  // ============================================
  (function () {
    const discoverLinks = document.querySelectorAll(
      ".service-card .link, .dept-item .link",
    );
    ...
    discoverLinks.forEach((link) => {
      link.addEventListener("click", function (e) {
        ...
        if (serviceId) {
          ...
          if (card) {
            const index =
              Array.from(document.querySelectorAll(".service-card")).indexOf(
                card,
              ) + 1;
...
if (contactForm) {
  contactForm.addEventListener("submit", function (e) {
    ...
    const newsletter = this.querySelector("#newsletter")?.checked
      ? "Oui"
      : "Non";
...
// ============================================
// 12. LIGHTBOX MOBILE — AGRANDIR LES IMAGES
// ============================================
(function () {
  ...
  const lightboxBg = document.querySelector(".gallery-lightbox .lightbox-bg");
  ...
  function openLightbox(imgSrc, imgAlt) {
    ...
    lightboxImg.alt = imgAlt || "Image";
    lightboxAlt.textContent = imgAlt || "";
  ...
  galleryItems.forEach((item) => {
    item.addEventListener("click", function (e) {
      // Ne l'activer que sur mobile (viewport <= 768px)
  ...
  // Fermer au clic sur le bg ou le bouton
  ...
  console.log("🖼️ Lightbox mobile activée — clique sur les images");
})();
